...
with col2:
    ...
    st.write("Microsoft Certified: PL-300 Power BI Data Analyst | Databricks Certified: Data Engineer Associate | Microsoft Certified: AZ-900 Azure Fundamentals | Microsoft Certified: AB-730 AI Business Professional")
    st.markdown("#### Contact")
